...
PDF_PATH = Path(r"C:\Users\Abhishek Ghalan\Downloads\Evangelical CHristian Collge 1.pdf")
OUT_DIR = Path(
...
def main() -> None:
    ...
    for page_number, page in enumerate(reader.pages, start=1):
        for image in page.images:
            ...
            destination = OUT_DIR / f"reports-page{page_number}-image{count}{extension}"
